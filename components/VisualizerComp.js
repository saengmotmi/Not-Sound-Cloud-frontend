...
const VisualizerComp = (props) => {
  ...
  useEffect(() => {
    ...
    for (j of dataUpscale) {
      ...
      ctxBot.fillRect(i, 0, 2.2, 0.8 * j); // x, y 시작점, width, height
      i += 3;
    }
  }, [musicData]);
